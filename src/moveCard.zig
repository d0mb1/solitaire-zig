...
pub fn flipCard() void {
    ...
    if (main.top_field[0][0].value == @intFromEnum(main.Value.joker)) {
        ...
        main.top_field[row_in_stack_9][stack9column].visible = true;
...
pub fn findExactCardBottom(column: u8, val: u8) u8 {
    var row: usize = 0;
    while (main.bottom_field[row][column].value != val or main.bottom_field[row][column].visible != true) : (row += 1) {
